...
INSERT INTO `projectalpha`.`product` (`ProductID`, `Product_Title`, `Product_Name`, `BrandID`, `SID`) VALUES ('002', 'Speaker', 'Q22', '112', '4');
INSERT INTO `projectalpha`.`product` (`ProductID`, `Product_Title`, `Product_Name`, `BrandID`, `SID`) VALUES ('003', 'PC', 'Custom Gaming', '113', '3');
...
INSERT INTO `projectalpha`.`product` (`ProductID`, `Product_Title`, `Product_Name`, `BrandID`, `SID`) VALUES ('006', 'Projector', 'CR26', '116', '5');
...
ALTER TABLE `projectalpha`.`store` 
ADD COLUMN `Street` VARCHAR(45) NULL AFTER `Province`;

UPDATE `projectalpha`.`store` SET `Street` = '214 Cambry St' WHERE (`StoreID` = '5111');
UPDATE `projectalpha`.`store` SET `Street` = '42-T hasting' WHERE (`StoreID` = '5853');
